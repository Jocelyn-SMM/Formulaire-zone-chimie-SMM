...
# Le chemin vers ton fichier sur le réseau
    ...
    <html>
      <body>
        <p>Bonjour,</p>
        <p>Un nouvel audit de la zone chimie vient d'être validé.</p>
        <p>
        - Date : {donnees['Date']}<br>
        - Auditeur : {donnees['Auditeur']}<br>
        - Remarques : {donnees['Remarques']}</p>

        <p>Pour voir l'audit complet avec les photos et la signature, clique sur le bouton ci-dessous :</p>
        
        <a href="{lien_hypertexte}" style="display: inline-block; background-color: #d9534f; color: #ffffff; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold; font-family: sans-serif;">
            Ouvrir le fichier Excel d'audit
        </a>
        
        <p><br><i>Si le bouton ne s'ouvre pas, faites un clic droit dessus, copiez l'adresse du lien, et collez-la dans votre explorateur de fichiers.</i></p>
      </body>
    </html>
    """
...
EXCEL_FILE = r"N:\05-HSE\9 - Audits de zone\Consultation audits zone chimie.xlsx"
