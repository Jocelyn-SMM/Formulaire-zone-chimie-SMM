...
def envoyer_notification(donnees):
    ...
    Veuillez consulter le fichier Excel "Consultation audits.xlsx" sur le réseau {"N:\05-HSE\9 - Audits de zone\Consultation audits.xlsx"} pour voir l'audit complet avec les photos et la signature.
...
EXCEL_FILE = r"N:\05-HSE\9 - Audits de zone\Consultation audits.xlsx"
    ...
    try:
        ...
        if os.path.exists(EXCEL_FILE):
            ...
            try:
                ...
                return jsonify({"status": "error", "message": "⚠️ Ferme le fichier Consultation audits.xlsx sur ton ordinateur avant de valider !"}), 500
        else:
